...
<head>
	...
	<!-- start: Meta -->
	<meta charset="utf-8">
	<title> Admin Dashboard - Srishty.net</title>
...
<body>
	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="index.html"><span>Srishty.net</span></a>			
				<!-- start: Header Menu -->
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="gallery.html"><i class="icon-picture"></i><span class="hidden-tablet"> Shop Name</span></a></li>
	...
	<footer>
		...
		<p>
			...
			<span class="hidden-phone" style="text-align:right;float:right">Powered by: <a href="#" alt="Bootstrap Admin Templates">Elegant IT</a></span>
		</p>
	</footer>
	<!-- start: JavaScript-->
